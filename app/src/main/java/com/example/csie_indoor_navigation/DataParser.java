...
public class DataParser {
    ...
    private static SharedPreferences languagePref;
    static String language_option;

    public DataParser(Context context) {
        this.appContext = context;
        this.languagePref = PreferenceManager.getDefaultSharedPreferences(appContext);
        this.language_option = languagePref.getString("language","繁體中文");
    }
                ...
                while (eventType != XmlPullParser.END_DOCUMENT) {
                    ...
                    if (eventType == XmlPullParser.START_TAG) {
                        ...
                        if (tag.equals("node")) {
                            ...
                            Log.i("nodeInSubgraph", "id = " + id + " node = " + node._waypointName);
